...
const plug = igniter({ prefix: '../tests/mocks/func-' })

const one = require('./mocks/func-one')
const two = require('./mocks/func-two')

jest.mock('./mocks/func-one')
jest.mock('./mocks/func-two')
